    ...
    <div>
      <section className="faq py-5">
        ...
        <div className="container faq_container">
          <Item question="Can I run multiple algos in the same account? Will there be conflicts if they trade same contract?" answer="You can run as many algos as you want in the same account (assuming you have the capital haha). There will not be any clashes or issues because each deployment on Tradetron is independent from others and tracks its own trades."/>
