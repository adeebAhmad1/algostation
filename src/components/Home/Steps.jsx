    ...
    <section className="steps py-5">
        <div className="container">
          ...
          <div className="row mb-3">
            ...
            <Step btn={<a rel="noreferrer"className="learn-more" style={{...btn,fontSize: "1.1rem"}} target="_blank" href="https://www.algostation.in/setup">Setup Platform</a> } step="03" bg="linear-gradient(to right, #7b4397, #dc2430)" content={<p className="w-100" style={{fontSize: "1.2rem"}}>
              <b>Go To Setup</b><br/>
