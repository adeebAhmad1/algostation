    ...
    <section className="steps py-5">
        <div className="container">
          ...
          <div className="row mb-3">
            ...
            <Step btn={<Link className="learn-more" style={{...btn,fontSize: "1.1rem"}} to="/setup">Setup Platform</Link> } step="03" bg="linear-gradient(to right, #7b4397, #dc2430)" content={<p className="w-100" style={{fontSize: "1.2rem"}}>
